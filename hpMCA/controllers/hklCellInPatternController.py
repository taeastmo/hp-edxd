...
class hklCellInPatternController(object):
    """
    PhaseInPatternController handles all the interaction between the phases and the pattern view.
    """

    def __init__(self, plotController, hklGenController,  pattern_widget, hkl_cell_model):
        """
        ...
        """
        self.phase_controller = hklGenController
        self.plotController  = plotController
        self.phase_model = hkl_cell_model
