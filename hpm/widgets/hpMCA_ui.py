...
class Ui_hpMCA(object):
    def setupUi(self, hpMCA):
        ...
        self._groupBoxElapsedLayout.addWidget(self.lblRealTime_lbl,2,0)
        self._groupBoxElapsedLayout.addWidget(self.lblLiveTime,1,1)
        self._groupBoxElapsedLayout.addWidget(self.lblRealTime,2,1)
        self._groupBoxElapsedLayout.addWidget(self.PLTM_pv,1,2)
        self._groupBoxElapsedLayout.addWidget(self.PRTM_pv,2,2)
