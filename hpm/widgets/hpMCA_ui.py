...
class Ui_hpMCA(object):
    def setupUi(self, hpMCA):
        ...
        self._groupBoxElapsedLayout.setContentsMargins(12,7,7,7)
        ...
        self.PLTM_1.setMaximumWidth(40)
        self.PLTM_2.setMaximumWidth(40)
        self.PLTM_30.setMaximumWidth(40)
        self.PLTM_60.setMaximumWidth(40)
        self.PLTM_120.setMaximumWidth(40)
        self.PLTM_0.setMaximumWidth(40)

        self.PLTM_btns = QtWidgets.QWidget()
        self._PLTM_btns_layout = QtWidgets.QGridLayout()
        self._PLTM_btns_layout.setSpacing(2)
        self._PLTM_btns_layout.setContentsMargins(0,0,0,0)
        ...
        self.PRTM_1.setMaximumWidth(40)
        self.PRTM_2.setMaximumWidth(40)
        self.PRTM_30.setMaximumWidth(40)
        self.PRTM_60.setMaximumWidth(40)
        self.PRTM_120.setMaximumWidth(40)
        self.PRTM_0.setMaximumWidth(40)

        self.PRTM_btns = QtWidgets.QWidget()
        self._PRTM_btns_layout = QtWidgets.QGridLayout()
        self._PRTM_btns_layout.setSpacing(2)
        self._PRTM_btns_layout.setContentsMargins(0,0,0,0)
