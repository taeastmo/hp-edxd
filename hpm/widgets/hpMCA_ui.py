...
class Ui_hpMCA(object):
    def setupUi(self, hpMCA):
        ...
        self.PLTM_1 = pvQMessageButton(message = '1')
        self.PLTM_2 = pvQMessageButton(message = '2')
        self.PLTM_30 = pvQMessageButton(message = '30')
        self.PLTM_60 = pvQMessageButton(message = '60')
        self.PLTM_120 = pvQMessageButton(message = '120')
        self.PLTM_0 = pvQMessageButton(message = '0')
        self.PLTM_1.setMaximumWidth(37)
        self.PLTM_2.setMaximumWidth(37)
        self.PLTM_30.setMaximumWidth(37)
        self.PLTM_60.setMaximumWidth(37)
        self.PLTM_120.setMaximumWidth(37)
        self.PLTM_0.setMaximumWidth(37)
        self.PLTM_1.setMaximumHeight(15)
        self.PLTM_2.setMaximumHeight(15)
        self.PLTM_30.setMaximumHeight(15)
        self.PLTM_60.setMaximumHeight(15)
        self.PLTM_120.setMaximumHeight(15)
        ...
        self._PLTM_btns_layout.addWidget( self.PLTM_30 ,1,0)
        self._PLTM_btns_layout.addWidget( self.PLTM_60 ,1,1)
        self._PLTM_btns_layout.addWidget( self.PLTM_120 ,1,2)
        self.PLTM_btns.setLayout(self._PLTM_btns_layout)

        self.PRTM_1 = pvQMessageButton(message = '1')
        self.PRTM_2 = pvQMessageButton(message = '2')
        self.PRTM_30 = pvQMessageButton(message = '30')
        self.PRTM_60 = pvQMessageButton(message = '60')
        self.PRTM_120 = pvQMessageButton(message = '120')
        self.PRTM_0 = pvQMessageButton(message = '0')
        self.PRTM_1.setMaximumWidth(37)
        self.PRTM_2.setMaximumWidth(37)
        self.PRTM_30.setMaximumWidth(37)
        self.PRTM_60.setMaximumWidth(37)
        self.PRTM_120.setMaximumWidth(37)
        self.PRTM_0.setMaximumWidth(37)
      
        self.PRTM_1.setMaximumHeight(15)
        self.PRTM_2.setMaximumHeight(15)
        self.PRTM_30.setMaximumHeight(15)
        self.PRTM_60.setMaximumHeight(15)
        self.PRTM_120.setMaximumHeight(15)
        ...
        self._PRTM_btns_layout.addWidget( self.PRTM_30 ,1,0)
        self._PRTM_btns_layout.addWidget( self.PRTM_60 ,1,1)
        self._PRTM_btns_layout.addWidget( self.PRTM_120 ,1,2)
